...
export const JAPAN_POIS = [
  ...
  { id: "shibuya-sky", name: "Shibuya Sky (observatório)", cat: "vista", lat: 35.6580, lng: 139.7016, costBRL: yen(2500), spendBRL: 0, duration: "1h30",
    ...
    howToBuy: "shibuya-sky.com (site oficial, horário marcado obrigatório)" },
  { id: "skytree", name: "Tokyo Skytree", cat: "vista", lat: 35.7101, lng: 139.8107, costBRL: yen(3100), spendBRL: 50, duration: "2h",
    ...
    howToBuy: "tokyo-skytree.jp (site oficial) — horário marcado evita fila na base" },
  ...
  { id: "teamlab", name: "teamLab Planets (Toyosu)", cat: "vista", lat: 35.6491, lng: 139.7897, costBRL: yen(3800), spendBRL: 0, duration: "2h30",
    ...
    howToBuy: "teamlab.art/e/planets (site oficial, ingresso com horário)" },
  ...
  { id: "ghibli", name: "Museu Ghibli (Mitaka)", cat: "geek", lat: 35.6962, lng: 139.5704, costBRL: yen(1000), spendBRL: 80, duration: "3h",
    ...
    howToBuy: "ghibli-museum.jp — no Brasil, vende pela Lawson Travel (JTB); fique de olho em cancelamentos" },
  ...
  { id: "disney", name: "Tokyo DisneySea", cat: "daytrip", lat: 35.6267, lng: 139.8851, costBRL: yen(10900), spendBRL: 250, duration: "dia inteiro",
    ...
    transport: "JR Keiyo → Maihama (~20min, ¥230)", tip: "¥8400-10900 conforme o dia. App do parque p/ filas. Dezembro tem decoração natalina!",
    howToBuy: "tokyodisneyresort.jp (site oficial) — data e horário fixos, compre com semanas de antecedência" },
  ...
  { id: "borderless", name: "teamLab Borderless (Azabudai Hills)", cat: "vista", lat: 35.6600, lng: 139.7414, costBRL: yen(3800), spendBRL: 0, duration: "3h",
    ...
    howToBuy: "teamlab.art/e/borderless (site oficial, ingresso com horário)" },
  ...
  { id: "usj", name: "Universal Studios Japan (Osaka)", cat: "extensao", lat: 34.6654, lng: 135.4323, costBRL: yen(8600), spendBRL: 200, duration: "dia inteiro",
    ...
    howToBuy: "usj.co.jp (site oficial) — compre a DATA + o horário do Nintendo World juntos" },
  ...
  // ===== 🎡 PARQUES & CULTURA: Tóquio =====
  { id: "rikugien", name: "Jardim Rikugien (iluminação noturna)", cat: "passeio", lat: 35.7280, lng: 139.7420, costBRL: yen(300), spendBRL: 0, duration: "1h30",
    desc: "Jardim de 1700 com lago central — à noite os momiji (bordos) são iluminados até dezembro.",
    transport: "JR Yamanote → Komagome (¥170)", tip: "¥300. Iluminação noturna geralmente até início de dez — confirme datas no site do parque.",
    howToBuy: "Entrada na hora, sem reserva — pago na bilheteria" },
  { id: "korakuen", name: "Jardim Koishikawa Korakuen", cat: "passeio", lat: 35.7056, lng: 139.7503, costBRL: yen(300), spendBRL: 0, duration: "1h",
    desc: "Um dos jardins mais antigos de Tóquio (1629), com pontes de pedra e miniaturas de paisagens chinesas.",
    transport: "Metrô → Iidabashi (¥180)", tip: "¥300. Muito mais vazio que o Shinjuku Gyoen — ótimo p/ fotos sem gente.",
    howToBuy: "Entrada na hora, sem reserva" },
  { id: "nezu-museum", name: "Museu Nezu + jardim japonês", cat: "passeio", lat: 35.6647, lng: 139.7157, costBRL: yen(1500), spendBRL: 0, duration: "2h",
    desc: "Arte asiática clássica num prédio moderno (Kuma Kengo) com jardim de bambu escondido em Omotesando.",
    transport: "Metrô → Omotesando (¥180)", tip: "¥1500. O jardim sozinho já vale — tem cafés escondidos no meio da mata.",
    howToBuy: "nezu-muse.or.jp (site oficial, venda antecipada recomendada em fds)" },
  { id: "design-sight", name: "21_21 Design Sight (Roppongi)", cat: "passeio", lat: 35.6658, lng: 139.7280, costBRL: yen(1400), spendBRL: 0, duration: "1h30",
    desc: "Galeria de design assinada por Ando Tadao + Issey Miyake — exposições que mudam a cada temporada.",
    transport: "Metrô → Roppongi (¥180)", tip: "¥1400 (varia por exposição). Combine com o Mori Art Museum, do lado.",
    howToBuy: "2121designsight.jp (site oficial)" },
  { id: "mori-art", name: "Mori Art Museum + Tokyo City View", cat: "passeio", lat: 35.6605, lng: 139.7292, costBRL: yen(2200), spendBRL: 0, duration: "2h",
    desc: "Museu de arte contemporânea no 53º andar + mirante panorâmico — aberto até 22h.",
    transport: "Metrô → Roppongi (¥180)", tip: "¥2200 combo museu+mirante. Vá ao entardecer: pega o dia e a noite na mesma visita.",
    howToBuy: "mori.art.museum (site oficial) ou na bilheteria" },
  { id: "ueno-zoo", name: "Zoológico de Ueno (pandas)", cat: "passeio", lat: 35.7166, lng: 139.7712, costBRL: yen(600), spendBRL: 30, duration: "2h",
    desc: "O zoo mais antigo do Japão (1882) — lar dos pandas-gigantes mais fofos de Tóquio.",
    transport: "JR Yamanote → Ueno (¥170)", tip: "¥600. Pandas ficam mais ativos de manhã — vá logo na abertura (9h30).",
    howToBuy: "Bilheteria na entrada ou app oficial do zoo (evita fila)" },
  { id: "sumida-aquarium", name: "Sumida Aquarium (Skytree Town)", cat: "passeio", lat: 35.7100, lng: 139.8100, costBRL: yen(2500), spendBRL: 0, duration: "1h30",
    desc: "Aquário moderno com tanque aberto de pinguins e um 'oceano de Tóquio' gigante sem vidro na parte de cima.",
    transport: "Metrô → Oshiage (¥180)", tip: "¥2500. Combine com a Skytree no mesmo dia (mesmo prédio).",
    howToBuy: "sumida-aquarium.com (site oficial)" },
  { id: "kahaku", name: "Museu Nacional de Ciência e Natureza", cat: "passeio", lat: 35.7168, lng: 139.7745, costBRL: yen(630), spendBRL: 0, duration: "2h30",
    desc: "Esqueleto de baleia na entrada, dinossauros, e a história natural do Japão em 2 prédios enormes.",
    transport: "JR Yamanote → Ueno (¥170)", tip: "¥630 — um dos museus mais baratos e completos da cidade.",
    howToBuy: "Bilheteria na entrada, sem necessidade de reserva" },
  { id: "design-festa", name: "Design Festa Gallery (Harajuku)", cat: "passeio", lat: 35.6706, lng: 139.7091, costBRL: 0, spendBRL: 0, duration: "45min",
    desc: "Galeria de arte alternativa GRÁTIS, prédio coberto de grafite por dentro e por fora — viral no Instagram.",
    transport: "A pé de Harajuku/Cat Street", tip: "GRÁTIS, aberto 24h nos fins de semana. Artistas vendem peças originais no local.",
    howToBuy: "Entrada livre, sem ingresso" },
  { id: "meguro-parasite", name: "Museu de Parasitologia de Meguro", cat: "passeio", lat: 35.6212, lng: 139.6994, costBRL: 0, spendBRL: 0, duration: "45min",
    desc: "O museu mais bizarro e viral de Tóquio: uma tênia de 8,8m em exposição. Grátis e hilário.",
    transport: "Tokyu Meguro (¥180)", tip: "GRÁTIS (doações bem-vindas). Tem loja com produtos 'parasita' de presente.",
    howToBuy: "Entrada livre" },
  { id: "samurai-museum", name: "Samurai Museum (Shinjuku)", cat: "passeio", lat: 35.6950, lng: 139.7030, costBRL: yen(2200), spendBRL: 0, duration: "1h",
    desc: "Armaduras samurai originais + experiência de vestir armadura e segurar espada de verdade.",
    transport: "Em Shinjuku (Kabukicho)", tip: "¥2200 com tour guiado em inglês incluso.",
    howToBuy: "samuraimuseum.jp (site oficial, reserva de horário recomendada)" },
  { id: "pokemon-cafe", name: "Pokémon Café (Nihonbashi)", cat: "passeio", lat: 35.6835, lng: 139.7730, costBRL: 0, spendBRL: 130, duration: "1h30",
    desc: "Café temático com pratos em formato de Pikachu — reserva concorridíssima, viral entre fãs.",
    transport: "Metrô → Nihonbashi (¥180)", tip: "Sem taxa de entrada, mas menu ¥1500-2500/pessoa é obrigatório. Reserva abre 1 mês antes.",
    howToBuy: "pokemon-cafe.jp (reserva obrigatória, abre exatamente 1 mês antes à 0h)" },

  // ===== 🎡 PARQUES & CULTURA: Osaka =====
  { id: "kaiyukan", name: "Aquário Kaiyukan (Osaka)", cat: "passeio", lat: 34.6547, lng: 135.4290, costBRL: yen(2700), spendBRL: 0, duration: "2h30",
    desc: "Um dos maiores aquários do mundo — tanque central de 9m com tubarão-baleia nadando por 8 andares.",
    transport: "Metrô → Osakako (¥180)", tip: "¥2700. Combine com o Tempozan Ferris Wheel ao lado.",
    howToBuy: "kaiyukan.com (site oficial) — comprar online evita fila de bilheteria" },
  { id: "osaka-castle", name: "Castelo de Osaka + parque", cat: "passeio", lat: 34.6873, lng: 135.5259, costBRL: yen(600), spendBRL: 0, duration: "2h",
    desc: "Castelo reconstruído (1931) com museu por dentro + parque gigante ao redor, ótimo p/ caminhar.",
    transport: "Metrô → Tanimachi 4-chome (¥180)", tip: "¥600 o museu; o parque em volta é grátis e enorme.",
    howToBuy: "Bilheteria na entrada do castelo, sem reserva necessária" },
  { id: "umeda-sky", name: "Umeda Sky Building (Floating Garden)", cat: "passeio", lat: 34.7053, lng: 135.4906, costBRL: yen(1500), spendBRL: 0, duration: "1h",
    desc: "Observatório circular a céu aberto entre duas torres — um dos mirantes mais fotografados do Japão.",
    transport: "A pé da Estação Osaka (10min)", tip: "¥1500. Vá ao pôr do sol — a vista muda de dia p/ noite na sua frente.",
    howToBuy: "kuchu-teien.com (site oficial) ou na bilheteria" },
  { id: "shitennoji", name: "Templo Shitennoji", cat: "passeio", lat: 34.6532, lng: 135.5162, costBRL: yen(300), spendBRL: 0, duration: "1h",
    desc: "O templo budista oficial mais antigo do Japão (593 d.C.) — pagode de 5 andares e jardim zen.",
    transport: "Metrô → Shitennoji-mae Yuhigaoka (¥180)", tip: "¥300 a área interna; os terrenos externos são grátis.",
    howToBuy: "Bilheteria na entrada" },
  { id: "nifrel", name: "NIFREL (zoo-aquário de design)", cat: "passeio", lat: 34.8022, lng: 135.5388, costBRL: yen(2200), spendBRL: 0, duration: "2h",
    desc: "Do time do Kaiyukan: animais e arte no mesmo espaço, iluminação de museu — super viral no Instagram.",
    transport: "Osaka Monorail → Expo-Koen (¥350)", tip: "¥2200. Fica ao lado do Parque Expo com a Torre do Sol.",
    howToBuy: "nifrel.jp (site oficial)" },
  { id: "tempozan-wheel", name: "Roda-gigante Tempozan + Harbor Village", cat: "passeio", lat: 34.6553, lng: 135.4283, costBRL: yen(900), spendBRL: 50, duration: "1h",
    desc: "Uma das maiores rodas-gigantes do Japão, vista da baía de Osaka — ilumina à noite em cores diferentes.",
    transport: "Ao lado do Kaiyukan", tip: "¥900. Combine com o aquário no mesmo passeio.",
    howToBuy: "Bilheteria no local" },
  { id: "nakanoshima-art", name: "Museu de Arte de Nakanoshima", cat: "passeio", lat: 34.6937, lng: 135.4936, costBRL: yen(1500), spendBRL: 0, duration: "1h30",
    desc: "Prédio preto cúbico moderno numa ilha fluvial — arte moderna japonesa e ocidental.",
    transport: "Metrô → Watanabebashi (¥180)", tip: "¥1500 (varia por exposição). Arquitetura sozinha já vale a foto.",
    howToBuy: "nakka-art.jp (site oficial)" },
  { id: "spaworld", name: "Spa World (banhos temáticos)", cat: "passeio", lat: 34.6520, lng: 135.5062, costBRL: yen(2900), spendBRL: 30, duration: "3h",
    desc: "Onsen temático gigante: andar 'Europa' e andar 'Ásia', piscinas e saunas por ¥2900 o dia todo.",
    transport: "Metrô → Shin-Imamiya (¥180)", tip: "⚠️ Tatuagem NÃO liberada aqui — prefiram os sento de Tóquio ou o kashikiri de Hakone.",
    howToBuy: "Bilheteria na entrada" },
  { id: "legoland-osaka", name: "Legoland Discovery Center Osaka", cat: "passeio", lat: 34.6659, lng: 135.4302, costBRL: yen(2600), spendBRL: 0, duration: "1h30",
    desc: "Espaço indoor de LEGO com miniatura de Osaka inteira feita de blocos — mais family mas divertido de qualquer forma.",
    transport: "Perto do Kaiyukan", tip: "¥2600. Compre combo com o aquário se for no mesmo dia.",
    howToBuy: "legolanddiscoverycenter.jp/osaka (site oficial)" },
  { id: "expo-tower", name: "Torre do Sol (Expo 70 Park)", cat: "passeio", lat: 34.8036, lng: 135.5364, costBRL: yen(930), spendBRL: 0, duration: "2h",
    desc: "Escultura icônica de 70m de Okamoto Taro — símbolo da Expo de 1970, com museu por dentro.",
    transport: "Osaka Monorail → Expo-Koen (¥350)", tip: "¥930 p/ entrar na torre. O parque ao redor é gigante e tranquilo.",
    howToBuy: "expo70-park.jp (site oficial)" },

  // ===== 🎡 PARQUES & CULTURA: Kyoto =====
  { id: "kiyomizu", name: "Kiyomizu-dera (templo icônico)", cat: "passeio", lat: 34.9949, lng: 135.7850, costBRL: yen(500), spendBRL: 40, duration: "2h",
    desc: "O templo mais famoso de Kyoto — palco de madeira suspenso sobre a encosta, sem um prego sequer.",
    transport: "Ônibus 100/206 até Kiyomizu-michi", tip: "¥500. Vá cedo (7h) p/ evitar multidão. Desça pela Sannen-zaka (ladeira histórica).",
    howToBuy: "Bilheteria na entrada" },
  { id: "nijo-castle", name: "Castelo Nijo", cat: "passeio", lat: 35.0142, lng: 135.7481, costBRL: yen(1300), spendBRL: 0, duration: "2h",
    desc: "Patrimônio UNESCO com 'assoalho de rouxinol' que canta ao andar — proteção anti-ninja do shogun.",
    transport: "Metrô Tozai → Nijojo-mae (¥260)", tip: "¥1300. O jardim ao redor também é lindo no inverno.",
    howToBuy: "Bilheteria na entrada ou site oficial da cidade de Kyoto" },
  { id: "kyoto-palace", name: "Palácio Imperial de Kyoto", cat: "passeio", lat: 35.0254, lng: 135.7622, costBRL: 0, spendBRL: 0, duration: "1h30",
    desc: "Residência oficial dos imperadores até 1868 — jardins e arquitetura Heian, entrada gratuita.",
    transport: "Metrô Karasuma → Imadegawa (¥260)", tip: "GRÁTIS. Passeio livre sem reserva desde a abertura ao público.",
    howToBuy: "Entrada livre — apenas documento de identidade na portaria" },
  { id: "philosophers-path", name: "Caminho do Filósofo", cat: "passeio", lat: 35.0270, lng: 135.7940, costBRL: 0, spendBRL: 60, duration: "2h",
    desc: "Trilha de 2km à beira de um canal entre Ginkaku-ji e Nanzen-ji — cafés escondidos no caminho.",
    transport: "Ônibus até Ginkakuji-michi", tip: "GRÁTIS. Combine com o Pavilhão de Prata (Ginkaku-ji, ¥500) numa ponta.",
    howToBuy: "Caminho livre, sem ingresso" },
  { id: "kyoto-railway", name: "Museu Ferroviário de Kyoto", cat: "passeio", lat: 34.9878, lng: 135.7414, costBRL: yen(1500), spendBRL: 0, duration: "2h",
    desc: "53 trens reais expostos, incluindo locomotivas a vapor que ainda circulam no pátio.",
    transport: "A pé da Estação Kyoto (20min) ou ônibus", tip: "¥1500. Ótimo se algum dos dois curte trem — o simulador de shinkansen é divertido.",
    howToBuy: "kyotorailwaymuseum.jp (site oficial)" },
  { id: "kodaiji", name: "Templo Kodai-ji (iluminado à noite)", cat: "passeio", lat: 35.0022, lng: 135.7797, costBRL: yen(600), spendBRL: 0, duration: "1h",
    desc: "Jardim zen com projeção de luz e arte digital à noite em dezembro — teamLab já fez instalação aqui em edições passadas.",
    transport: "A pé de Gion/Higashiyama", tip: "¥600. Confira no site se a iluminação de inverno está confirmada p/ dez/2026.",
    howToBuy: "Bilheteria na entrada; confirmar datas da iluminação no site do templo" },
  { id: "tofukuji", name: "Templo Tofuku-ji", cat: "passeio", lat: 34.9776, lng: 135.7738, costBRL: yen(500), spendBRL: 0, duration: "1h30",
    desc: "Famoso pelo vale de bordos (Tsutenkyo) — mesmo sem as folhas de outono, o jardim zen de pedra é excelente.",
    transport: "JR Nara Line → Tofukuji (¥150)", tip: "¥500 (jardim + Tsutenkyo). Muito mais vazio que Kiyomizu no inverno.",
    howToBuy: "Bilheteria na entrada" },
  { id: "kyoto-tower", name: "Kyoto Tower", cat: "passeio", lat: 34.9880, lng: 135.7593, costBRL: yen(900), spendBRL: 0, duration: "45min",
    desc: "Torre de observação em frente à Estação Kyoto — vista 360° da cidade baixa cercada de montanhas.",
    transport: "Em frente à Estação Kyoto", tip: "¥900. Bom p/ orientação no primeiro dia em Kyoto.",
    howToBuy: "kyoto-tower.co.jp (site oficial) ou na bilheteria" },
  { id: "manga-museum", name: "Museu Internacional do Mangá de Kyoto", cat: "passeio", lat: 35.0116, lng: 135.7583, costBRL: yen(1200), spendBRL: 0, duration: "2h",
    desc: "300 mil volumes de mangá numa antiga escola — pode sentar no gramado e ler à vontade.",
    transport: "Metrô Tozai/Karasuma → Karasuma-Oike (¥260)", tip: "¥1200. Maioria em japonês, mas a experiência vale mesmo sem ler.",
    howToBuy: "kyotomm.jp (site oficial)" },
  { id: "gear-theatre", name: "GEAR — teatro não-verbal de Kyoto", cat: "passeio", lat: 35.0095, lng: 135.7686, costBRL: yen(4500), spendBRL: 0, duration: "1h30",
    desc: "Show de mímica, projeção e dança contemporânea sem diálogo — sucesso surpresa entre turistas há 10+ anos.",
    transport: "A pé de Kawaramachi/Gion", tip: "¥4500. Reserve online — casas pequenas esgotam rápido.",
    howToBuy: "gear-theater.com (site oficial, em inglês)" },

  // ===== 🎡 MAIS PARQUES, DIVERSÃO E CULTURA: Tóquio (22) =====
  { id: "yoyogi-park", name: "Parque Yoyogi", cat: "passeio", lat: 35.6717, lng: 139.6947, costBRL: 0, spendBRL: 30, duration: "1h30",
    desc: "O 'Central Park' de Tóquio — grama enorme, ciclovia, e aos domingos artistas de rua e bandas ensaiando.",
    transport: "JR Yamanote → Harajuku (¥170)", tip: "GRÁTIS. Combine com Meiji Jingu, que fica colado.",
    howToBuy: "Entrada livre" },
  { id: "shizen-kyoiku", name: "Institute for Nature Study (Shirokanedai)", cat: "passeio", lat: 35.6398, lng: 139.7217, costBRL: yen(320), spendBRL: 0, duration: "1h30",
    desc: "Reserva florestal selvagem escondida no meio da cidade — parece que você saiu de Tóquio sem sair.",
    transport: "JR Yamanote → Meguro (¥170)", tip: "¥320. Bem menos conhecido — praticamente vazio mesmo em fds.",
    howToBuy: "Bilheteria na entrada" },
  { id: "momat", name: "Museu Nacional de Arte Moderna (MOMAT)", cat: "passeio", lat: 35.6903, lng: 139.7573, costBRL: yen(700), spendBRL: 0, duration: "2h",
    desc: "Arte japonesa moderna de 1900 até hoje, a 5min do Palácio Imperial.",
    transport: "Metrô → Takebashi (¥180)", tip: "¥700 (varia por mostra). Salas com vista pro fosso do palácio.",
    howToBuy: "momat.go.jp (site oficial)" },
  { id: "edo-open-air", name: "Museu de Arquitetura Edo-Tóquio (Open Air)", cat: "passeio", lat: 35.7136, lng: 139.5192, costBRL: yen(400), spendBRL: 0, duration: "2h30",
    desc: "30 prédios históricos reais transportados e remontados num parque — inclusive uma casa de banho antiga que inspirou 'A Viagem de Chihiro'.",
    transport: "JR Chuo → Koganei + ônibus (¥400)", tip: "¥400. Longe mas único — é literalmente andar dentro de um cenário do Ghibli.",
    howToBuy: "Bilheteria na entrada" },
  { id: "disneyland-tokyo", name: "Tokyo Disneyland", cat: "daytrip", lat: 35.6329, lng: 139.8804, costBRL: yen(10900), spendBRL: 250, duration: "dia inteiro",
    desc: "O parque clássico da Disney (diferente da DisneySea) — castelo, desfiles, e o 'mundo mais feliz' em versão japonesa.",
    transport: "JR Keiyo → Maihama (~20min, ¥230)", tip: "Se só der p/ 1 parque, DisneySea é mais única no mundo. Este é o clássico 'de sempre'.",
    howToBuy: "tokyodisneyresort.jp (site oficial) — data e horário fixos" },
  { id: "joypolis", name: "SEGA Joypolis (Odaiba)", cat: "geek", lat: 35.6284, lng: 139.7754, costBRL: yen(1000), spendBRL: 150, duration: "3h",
    desc: "Parque indoor de jogos e simuladores da SEGA — VR, montanha-russa indoor, tudo em 3 andares.",
    transport: "Yurikamome → Odaiba-Kaihinkoen (¥330)", tip: "¥1000 entrada + paga por atração, ou passaporte ¥4500 ilimitado.",
    howToBuy: "tokyo-joypolis.com (site oficial)" },
  { id: "round1", name: "Round1 Stadium (bowling + arcade 24h)", cat: "geek", lat: 35.6595, lng: 139.6980, costBRL: yen(1500), spendBRL: 60, duration: "2h30",
    desc: "Complexo gigante: boliche, karaokê, arcade, batting cage — tudo num prédio, aberto a noite toda.",
    transport: "Em Shibuya (várias unidades)", tip: "~¥1500/h. Ótimo plano de madrugada se perderem o último trem.",
    howToBuy: "round1.co.jp (site oficial, sem reserva — chegar e jogar)" },
  { id: "kasai-rinkai", name: "Parque Kasai Rinkai + Roda-gigante", cat: "passeio", lat: 35.6420, lng: 139.8567, costBRL: yen(800), spendBRL: 0, duration: "2h",
    desc: "Parque à beira-mar com uma das maiores rodas-gigantes do Japão — vista da Skytree e até do Fuji em dia limpo.",
    transport: "JR Keiyo → Kasai-Rinkai-koen (¥210)", tip: "Parque grátis; roda-gigante ¥800.",
    howToBuy: "Bilheteria na roda-gigante" },
  { id: "tokyo-dome-city", name: "Tokyo Dome City Attractions (montanha-russa urbana)", cat: "passeio", lat: 35.7060, lng: 139.7519, costBRL: yen(1200), spendBRL: 0, duration: "2h",
    desc: "A montanha-russa Thunder Dolphin passa por DENTRO de um prédio e por cima de uma roda-gigante sem eixo central — cena clássica de Tóquio.",
    transport: "Metrô → Suidobashi (¥180)", tip: "¥1200/atração ou passaporte ¥4200. A roda-gigante 'sem centro' é única no mundo.",
    howToBuy: "at-raku.com (site oficial) ou na bilheteria" },
  { id: "national-art-center", name: "National Art Center Tokyo (Roppongi)", cat: "passeio", lat: 35.6653, lng: 139.7263, costBRL: yen(1500), spendBRL: 0, duration: "1h30",
    desc: "O maior espaço de exposições do Japão, num prédio de vidro ondulado — sem acervo próprio, sempre tem mostra nova.",
    transport: "Metrô → Nogizaka (¥180)", tip: "¥1500 (varia por exposição). A arquitetura por dentro já vale a visita.",
    howToBuy: "nact.jp (site oficial)" },
  { id: "gingko-avenue", name: "Avenida dos Gingkos (Jingu Gaien)", cat: "passeio", lat: 35.6751, lng: 139.7180, costBRL: 0, spendBRL: 40, duration: "45min",
    desc: "146 árvores de gingko formando um túnel dourado — um dos passeios mais fotografados do outono/início de inverno em Tóquio.",
    transport: "Metrô → Aoyama-itchome (¥180)", tip: "GRÁTIS. Auge geralmente fim de nov/início de dez — podem pegar as folhas ainda no chão.",
    howToBuy: "Passeio livre, sem ingresso" },
  { id: "sunshine-sky-circus", name: "Sky Circus Sunshine 60 (Ikebukuro)", cat: "vista", lat: 35.7295, lng: 139.7195, costBRL: yen(1200), spendBRL: 0, duration: "1h",
    desc: "Observatório com atrações de VR e projeção — parte mirante, parte parque de diversões.",
    transport: "JR Yamanote → Ikebukuro (¥170)", tip: "¥1200. Combine com o Pokémon Center e Namja Town no mesmo prédio (Sunshine City).",
    howToBuy: "sunshinecity.jp (site oficial)" },
  { id: "namja-town", name: "Namja Town (parque indoor retrô)", cat: "geek", lat: 35.7299, lng: 139.7192, costBRL: yen(500), spendBRL: 150, duration: "2h",
    desc: "Parque temático indoor bizarro e nostálgico: 'cidade dos gyoza' e 'cidade das sobremesas' dentro do mesmo prédio.",
    transport: "Em Sunshine City, Ikebukuro", tip: "¥500 entrada + paga por atração (~¥3500 passaporte).",
    howToBuy: "namja.jp (site oficial)" },
  { id: "j-world", name: "J-World Tokyo (parque de anime)", cat: "geek", lat: 35.7301, lng: 139.7189, costBRL: yen(800), spendBRL: 100, duration: "2h",
    desc: "Parque temático de One Piece, Dragon Ball e Naruto dentro do Sunshine City — atrações e cenários reais dos animes.",
    transport: "Em Sunshine City, Ikebukuro", tip: "¥800 entrada + atrações à parte, ou passaporte ¥3500.",
    howToBuy: "j-world.com (site oficial)" },
  { id: "character-street", name: "Tokyo Character Street (Tokyo Station)", cat: "geek", lat: 35.6812, lng: 139.7660, costBRL: 0, spendBRL: 200, duration: "1h",
    desc: "Corredor no subsolo da estação com 20+ lojas oficiais: Pokémon, Ghibli, Sanrio, Jump, Ultraman — tudo junto.",
    transport: "Tokyo Station (subsolo Yaesu)", tip: "GRÁTIS pra passear; leve dinheiro pros souvenirs oficiais.",
    howToBuy: "Entrada livre — loja por loja" },
  { id: "showa-kinen", name: "Parque Showa Kinen (Tachikawa)", cat: "passeio", lat: 35.7080, lng: 139.4090, costBRL: yen(450), spendBRL: 0, duration: "3h",
    desc: "Parque gigante (mais que o Central Park) com campos de flores por estação e ciclovias — dez tem iluminação de Natal.",
    transport: "JR Chuo → Tachikawa (~40min, ¥480)", tip: "¥450. Alugue bike lá dentro (¥410) — o parque é grande demais pra andar tudo a pé.",
    howToBuy: "Bilheteria na entrada" },
  { id: "kiddyland", name: "Kiddyland Harajuku (loja de brinquedos)", cat: "passeio", lat: 35.6703, lng: 139.7050, costBRL: 0, spendBRL: 150, duration: "1h",
    desc: "6 andares de brinquedos, Sanrio, Studio Ghibli e personagens só encontrados no Japão — diversão mesmo sem comprar nada.",
    transport: "Em Omotesando/Harajuku", tip: "GRÁTIS pra passear e testar tudo.",
    howToBuy: "Entrada livre" },
  { id: "sea-life-park", name: "Tokyo Sea Life Park (Kasai)", cat: "passeio", lat: 35.6396, lng: 139.8459, costBRL: yen(700), spendBRL: 0, duration: "2h",
    desc: "Aquário com prédio em formato de disco de vidro flutuante — tanque de atum bluefin gigante circulando.",
    transport: "JR Keiyo → Kasai-Rinkai-koen (¥210)", tip: "¥700 — mais barato e menos cheio que o Sumida Aquarium.",
    howToBuy: "Bilheteria na entrada" },
  { id: "wb-studio-tour", name: "Warner Bros. Studio Tour Tokyo (Harry Potter)", cat: "passeio", lat: 35.7469, lng: 139.6580, costBRL: yen(3500), spendBRL: 200, duration: "4h",
    desc: "Réplica dos sets reais de Harry Potter — Salão Principal, Beco Diagonal, o trem — inaugurado em 2023, virou febre.",
    transport: "Seibu-Ikebukuro → Toshimaen (~13min, ¥190)", tip: "¥3500+. Ingresso com HORÁRIO marcado — esgota, compre com 2-3 semanas de antecedência.",
    howToBuy: "wbstudiotour.jp (site oficial, obrigatório reservar data+hora)" },
  { id: "shinagawa-aqua", name: "Shinagawa Aquarium", cat: "passeio", lat: 35.6058, lng: 139.7402, costBRL: yen(1500), spendBRL: 0, duration: "1h30",
    desc: "Aquário com túnel submerso e show de golfinhos — menor e mais tranquilo que os grandes de Odaiba.",
    transport: "Keikyu → Omorikaigan (¥180)", tip: "¥1500. Boa opção se quiserem fugir da multidão dos aquários mais famosos.",
    howToBuy: "Bilheteria na entrada" },
  { id: "yebisu-beer", name: "Museu da Cerveja Yebisu", cat: "passeio", lat: 35.6435, lng: 139.7160, costBRL: 0, spendBRL: 40, duration: "1h",
    desc: "Museu grátis sobre a história da cervejaria + degustação paga no final — clássico e charmoso.",
    transport: "JR Yamanote → Ebisu (¥170)", tip: "Entrada grátis; degustação ~¥400/copo.",
    howToBuy: "Entrada livre; degustação paga no local" },
  { id: "origami-kaikan", name: "Origami Kaikan (museu + oficina)", cat: "passeio", lat: 35.7059, lng: 139.7716, costBRL: 0, spendBRL: 60, duration: "1h",
    desc: "Prédio histórico dedicado à arte do origami — você pode ver artesãos trabalhando e fazer sua própria dobradura.",
    transport: "Metrô → Ochanomizu (¥180)", tip: "GRÁTIS pra visitar; workshops pagos a partir de ¥1000.",
    howToBuy: "origamikaikan.co.jp (site oficial)" },

  // ===== 🎡 MAIS PARQUES, DIVERSÃO E CULTURA: Osaka (14) =====
  { id: "osaka-history", name: "Museu de História de Osaka", cat: "passeio", lat: 34.6822, lng: 135.5257, costBRL: yen(600), spendBRL: 0, duration: "1h30",
    desc: "Prédio moderno ao lado do castelo — do 10º andar dá pra ver ruínas arqueológicas reais embaixo do museu.",
    transport: "Metrô → Tanimachi 4-chome (¥180)", tip: "¥600. Combine com o Castelo de Osaka, que fica ao lado.",
    howToBuy: "osakamushis.jp (site oficial) ou na bilheteria" },
  { id: "nakanoshima-park", name: "Parque Nakanoshima (ilha fluvial)", cat: "passeio", lat: 34.6935, lng: 135.4990, costBRL: 0, spendBRL: 30, duration: "1h",
    desc: "Faixa verde entre dois rios no centro de Osaka — jardim de rosas e prédios históricos ao redor.",
    transport: "Metrô → Yodoyabashi/Kitahama (¥180)", tip: "GRÁTIS. Ótimo p/ caminhar entre os museus da área (Nakanoshima).",
    howToBuy: "Passeio livre" },
  { id: "osaka-science", name: "Museu de Ciências de Osaka", cat: "passeio", lat: 34.6942, lng: 135.4930, costBRL: yen(400), spendBRL: 0, duration: "2h",
    desc: "Planetário + experimentos interativos de física e espaço — divertido mesmo sem falar japonês.",
    transport: "Metrô → Yodoyabashi (¥180)", tip: "¥400 exposições + ¥600 planetário.",
    howToBuy: "sci-museum.jp (site oficial)" },
  { id: "national-art-osaka", name: "Museu Nacional de Arte, Osaka (subterrâneo)", cat: "passeio", lat: 34.6928, lng: 135.4917, costBRL: yen(800), spendBRL: 0, duration: "1h30",
    desc: "Museu inteiro DEBAIXO da terra — só a entrada em formato de bambu de aço aparece na superfície.",
    transport: "Metrô → Yodoyabashi (¥180)", tip: "¥800 (varia por mostra). A arquitetura da entrada já é obra de arte.",
    howToBuy: "nmao.go.jp (site oficial)" },
  { id: "cupnoodles-ikeda", name: "Museu Cup Noodles (Ikeda, Osaka)", cat: "passeio", lat: 34.8175, lng: 135.4256, costBRL: 0, spendBRL: 60, duration: "2h",
    desc: "O museu ORIGINAL da Nissin (diferente do de Yokohama) — onde o macarrão instantâneo foi inventado, com oficina p/ criar seu próprio cup noodle.",
    transport: "Hankyu Takarazuka → Ikeda (~20min, ¥280)", tip: "Entrada GRÁTIS; a oficina do seu cup noodle personalizado é ¥500.",
    howToBuy: "cupnoodles-museum.jp (site oficial, reservar workshop online)" },
  { id: "tsutenkaku", name: "Torre Tsutenkaku (símbolo de Shinsekai)", cat: "passeio", lat: 34.6524, lng: 135.5063, costBRL: yen(1000), spendBRL: 0, duration: "1h",
    desc: "A torre retrô que é CARA de Osaka — luzes de néon, estátua dourada do Billiken (deus da sorte) no topo.",
    transport: "Metrô → Ebisucho (¥180)", tip: "¥1000. Combine com o bairro Shinsekai e kushikatsu ao redor.",
    howToBuy: "tsutenkaku.co.jp (site oficial)" },
  { id: "minoo-park", name: "Parque Minoo (cachoeira + tempurá de folha)", cat: "daytrip", lat: 34.8434, lng: 135.4720, costBRL: 0, spendBRL: 40, duration: "3h",
    desc: "Trilha de 3km até uma cachoeira de 33m — no caminho, barracas vendem o famoso 'tempurá de folha de bordo'.",
    transport: "Hankyu → Minoo (~25min, ¥280)", tip: "GRÁTIS a trilha. Tempurá de momiji ~¥400 o pacote.",
    howToBuy: "Passeio livre; comida paga nas barracas" },
  { id: "osaka-fine-arts", name: "Museu Municipal de Belas Artes de Osaka", cat: "passeio", lat: 34.6540, lng: 135.5150, costBRL: yen(700), spendBRL: 0, duration: "1h30",
    desc: "Reaberto após reforma em 2022, dentro do Parque Tennoji — acervo de arte japonesa e asiática clássica.",
    transport: "Metrô → Tennoji (¥180)", tip: "¥700. Combine com o zoo e Shitennoji no mesmo passeio.",
    howToBuy: "Bilheteria na entrada" },
  { id: "tennoji-zoo", name: "Zoológico de Tennoji (Osaka)", cat: "passeio", lat: 34.6513, lng: 135.5150, costBRL: yen(500), spendBRL: 0, duration: "2h",
    desc: "Zoo centenário dentro do Parque Tennoji — leões, girafas e um recinto de savana africana bem feito.",
    transport: "Metrô → Tennoji (¥180)", tip: "¥500. Bom intervalo entre Shitennoji e Shinsekai/Tsutenkaku.",
    howToBuy: "Bilheteria na entrada" },
  { id: "hep-five", name: "Roda-gigante vermelha HEP FIVE (Umeda)", cat: "passeio", lat: 34.7038, lng: 135.4988, costBRL: yen(700), spendBRL: 0, duration: "45min",
    desc: "Roda-gigante gigante e vermelha NO TOPO de um shopping — vista de Umeda de uma cabine de vidro.",
    transport: "A pé da Estação Osaka", tip: "¥700. Curto e ótimo pôr do sol, dentro de um shopping cheio de lojas jovens.",
    howToBuy: "Bilheteria no 7º andar do shopping HEP FIVE" },
  { id: "amerikamura", name: "Amerikamura (America Village)", cat: "bairro", lat: 34.6725, lng: 135.4970, costBRL: 0, spendBRL: 150, duration: "2h",
    desc: "Bairro jovem cheio de grafite, brechós americanos e streetwear — a resposta de Osaka ao Harajuku.",
    transport: "Metrô → Shinsaibashi (¥180)", tip: "GRÁTIS pra passear. Triangle Park é o point de encontro.",
    howToBuy: "Passeio livre" },
  { id: "osaka-natural-history", name: "Museu de História Natural de Osaka", cat: "passeio", lat: 34.6046, lng: 135.5140, costBRL: yen(300), spendBRL: 0, duration: "1h30",
    desc: "Dentro do Parque Nagai — esqueletos de dinossauro e a fauna/flora típica do Japão.",
    transport: "Metrô → Nagai (¥180)", tip: "¥300 — um dos museus mais baratos de Osaka.",
    howToBuy: "Bilheteria na entrada" },
  { id: "nagai-park", name: "Parque Nagai", cat: "passeio", lat: 34.6037, lng: 135.5170, costBRL: 0, spendBRL: 20, duration: "1h",
    desc: "Parque verde grande com estádio, jardim de plantas e trilhas — respiro tranquilo fora do centro.",
    transport: "Metrô → Nagai (¥180)", tip: "GRÁTIS. Combine com o Museu de História Natural, que fica dentro dele.",
    howToBuy: "Passeio livre" },
  { id: "konjaku-kan", name: "Museu da Vida e Moradia de Osaka (Konjaku Kan)", cat: "passeio", lat: 34.7033, lng: 135.5188, costBRL: yen(600), spendBRL: 0, duration: "1h30",
    desc: "Recria uma rua inteira de Osaka do período Edo em tamanho real, DENTRO de um prédio — dá pra vestir quimono e passear pela réplica.",
    transport: "Metrô → Tenjinbashisuji 6-chome (¥180)", tip: "¥600. Aluguel de quimono p/ fotos na réplica ~¥2000.",
    howToBuy: "konjyakukan.com (site oficial)" },

  // ===== 🎡 MAIS PARQUES, DIVERSÃO E CULTURA: Kyoto (10) =====
  { id: "kyoto-botanical", name: "Jardim Botânico de Kyoto", cat: "passeio", lat: 35.0453, lng: 135.7625, costBRL: yen(200), spendBRL: 0, duration: "2h",
    desc: "O maior jardim botânico do Japão — estufa tropical + 12 mil espécies de plantas ao ar livre.",
    transport: "Metrô Karasuma → Kitayama (¥260)", tip: "¥200. Muito vazio comparado aos templos — ótimo p/ caminhar sem pressa.",
    howToBuy: "Bilheteria na entrada" },
  { id: "kyoto-aquarium", name: "Aquário de Kyoto", cat: "passeio", lat: 34.9855, lng: 135.7434, costBRL: yen(2400), spendBRL: 0, duration: "2h",
    desc: "Aquário moderno com foco em espécies de água doce do Japão + show de golfinhos ao ar livre.",
    transport: "A pé da Estação Kyoto (~15min) ou ônibus", tip: "¥2400. Bom plano p/ dia de chuva em Kyoto.",
    howToBuy: "kyoto-aquarium.com (site oficial)" },
  { id: "toei-studio-park", name: "Toei Kyoto Studio Park (parque de samurai/ninja)", cat: "passeio", lat: 35.0161, lng: 135.7186, costBRL: yen(2400), spendBRL: 100, duration: "3h",
    desc: "Estúdio de cinema de filmes de época virou parque temático: ruas de samurai reais, shows de espada ao vivo, aluguel de fantasia.",
    transport: "JR Sagano → Uzumasa (¥240)", tip: "¥2400. Se curtem cultura samurai/ninja, é o passeio mais único e divertido do Kansai.",
    howToBuy: "toei-eigamura.com (site oficial)" },
  { id: "sanjusangendo", name: "Sanjusangen-do (mil estátuas de Kannon)", cat: "passeio", lat: 34.9877, lng: 135.7717, costBRL: yen(600), spendBRL: 0, duration: "1h",
    desc: "Salão de madeira de 120m com 1001 estátuas douradas de Kannon em fileiras — uma das cenas mais impressionantes de Kyoto.",
    transport: "Ônibus até Sanjusangendo-mae", tip: "¥600. Proibido fotografar lá dentro — mas vale só pra ver ao vivo.",
    howToBuy: "Bilheteria na entrada" },
  { id: "ginkakuji", name: "Ginkaku-ji (Pavilhão de Prata)", cat: "passeio", lat: 35.0270, lng: 135.7982, costBRL: yen(500), spendBRL: 0, duration: "1h",
    desc: "Apesar do nome, nunca foi coberto de prata — jardim de areia rastelada e musgo perfeitos, no início do Caminho do Filósofo.",
    transport: "Ônibus até Ginkakuji-michi", tip: "¥500. Combine com a caminhada até Nanzen-ji pelo Caminho do Filósofo.",
    howToBuy: "Bilheteria na entrada" },
  { id: "nishi-hongwanji", name: "Templo Nishi Hongwanji", cat: "templo", lat: 34.9914, lng: 135.7530, costBRL: 0, spendBRL: 0, duration: "1h",
    desc: "Patrimônio UNESCO gratuito — um dos maiores salões de madeira do Japão, perto da Estação Kyoto.",
    transport: "A pé da Estação Kyoto (~15min)", tip: "GRÁTIS. Ótimo p/ encaixar na chegada ou saída de Kyoto.",
    howToBuy: "Entrada livre" },
  { id: "kyocera-museum", name: "Museu Municipal de Arte de Kyoto (Kyocera)", cat: "passeio", lat: 35.0161, lng: 135.7822, costBRL: yen(730), spendBRL: 0, duration: "1h30",
    desc: "Prédio de 1933 renovado por Nishizawa Ryue — mistura arquitetura clássica japonesa com ala nova de vidro.",
    transport: "Ônibus até Higashiyama Nijo/Okazaki", tip: "¥730 (varia por exposição). Fica ao lado do Heian Jingu.",
    howToBuy: "kyotocity-kyocera.museum (site oficial)" },
  { id: "kurama-kibune", name: "Kurama-dera + vale de Kibune", cat: "daytrip", lat: 35.1156, lng: 135.7714, costBRL: yen(300), spendBRL: 100, duration: "meio dia",
    desc: "Trilha de montanha entre um templo com lendas de tengu (Kurama) e um vale de restaurantes sobre o rio (Kibune).",
    transport: "Eizan Railway de Demachiyanagi (~30min, ¥470)", tip: "¥300 o templo. No verão os restaurantes de Kibune servem em plataformas sobre o rio.",
    howToBuy: "Bilheteria na entrada do templo" },
  { id: "fureaikan", name: "Fureaikan — Museu de Artesanato Tradicional de Kyoto", cat: "passeio", lat: 35.0064, lng: 135.7815, costBRL: 0, spendBRL: 0, duration: "1h",
    desc: "Museu grátis dedicado aos 74 ofícios tradicionais de Kyoto — cerâmica, leque, tecelagem — com demonstrações ao vivo.",
    transport: "Ônibus até Okazaki-koen", tip: "GRÁTIS. Combine com o Kyocera Museum e o Heian Jingu, que ficam do lado.",
    howToBuy: "Entrada livre" },
  { id: "eikando", name: "Templo Eikan-dō (Buda que olha pra trás)", cat: "passeio", lat: 35.0157, lng: 135.7936, costBRL: yen(600), spendBRL: 0, duration: "1h",
    desc: "Famoso pela estátua do 'Buda Mikaeri' — a única imagem budista do Japão esculpida olhando por cima do ombro.",
    transport: "Ônibus até Nanzenji-Eikando-michi", tip: "¥600. Fica na outra ponta do Caminho do Filósofo, perto do Nanzen-ji.",
    howToBuy: "Bilheteria na entrada" },

  // ===== 🎡 MAIS PARQUES, DIVERSÃO E CULTURA: arredores/day trips (4) =====
  { id: "fujiq", name: "Fuji-Q Highland (montanhas-russas + vista do Fuji)", cat: "daytrip", lat: 35.4870, lng: 138.7800, costBRL: yen(6500), spendBRL: 150, duration: "dia inteiro",
    desc: "Parque com algumas das montanhas-russas mais extremas do mundo (Fujiyama, Do-Dodonpa) e o Monte Fuji como cenário de fundo.",
    transport: "Ônibus direto de Shinjuku (~2h, ¥2200)", tip: "¥6500 passaporte. Vá em dia de semana — filas de fds passam de 2h por brinquedo.",
    howToBuy: "fujiq.jp (site oficial)" },
  { id: "enoshima-aqua", name: "Aquário de Enoshima", cat: "daytrip", lat: 35.3009, lng: 139.4784, costBRL: yen(2500), spendBRL: 0, duration: "2h",
    desc: "Aquário à beira-mar com show de golfinhos com o Monte Fuji ao fundo em dia limpo — combina perfeito com o day trip de Kamakura.",
    transport: "Odakyu/Enoden até Katase-Enoshima", tip: "¥2500. Encaixe no mesmo dia do passeio a Kamakura/Enoshima já planejado.",
    howToBuy: "enosui.com (site oficial)" },
  { id: "cosmoworld", name: "Yokohama Cosmoworld (parque + roda-gigante Cosmo Clock)", cat: "daytrip", lat: 35.4544, lng: 139.6367, costBRL: yen(900), spendBRL: 60, duration: "2h",
    desc: "Parque de diversões urbano dentro de Minato Mirai — a roda-gigante Cosmo Clock 21 também funciona como relógio gigante.",
    transport: "JR Tokaido → Yokohama + caminhada (~40min total)", tip: "Entrada no parque grátis, paga por brinquedo — a roda-gigante ¥900.",
    howToBuy: "Bilheteria no local, sem reserva" },
  { id: "sankeien", name: "Jardim Sankeien (Yokohama)", cat: "daytrip", lat: 35.4103, lng: 139.6608, costBRL: yen(700), spendBRL: 0, duration: "1h30",
  ...
  // 🚄 Clássicos dos roteiros de agência (conferidos em set/2026)
  { id: "hakone-ashi", name: "Lago Ashi + torii do Hakone-jinja", cat: "daytrip", lat: 35.2048, lng: 139.0260, costBRL: yen(6100), spendBRL: 60, duration: "11h",
    desc: "Barco-pirata no lago com o torii vermelho dentro d'água e o Fuji de fundo. Circuito clássico de Hakone.",
    transport: "Odakyu de Shinjuku → Odawara, ~90 min", tip: "Hakone Freepass resolve os 5 transportes num ticket só. Vá cedo: o Fuji some conforme a manhã avança.",
    howToBuy: "odakyu-global.com — Hakone Freepass 2 dias, ~¥6.100–7.100 de Shinjuku" },
  { id: "owakudani", name: "Owakudani — vale vulcânico", cat: "daytrip", lat: 35.2444, lng: 139.0201, costBRL: 0, spendBRL: 20, duration: "1h",
    desc: "Fumarolas de enxofre e os ovos pretos cozidos na fonte termal. Dizem que cada ovo dá 7 anos de vida.",
    transport: "Teleférico de Hakone (incluso no Freepass)", tip: "O teleférico fecha sem aviso quando o gás vulcânico sobe — confira o status no dia." },
  { id: "chureito", name: "Pagode Chureito (o Fuji do cartão-postal)", cat: "daytrip", lat: 35.5005, lng: 138.8003, costBRL: 0, spendBRL: 0, duration: "2h",
    desc: "398 degraus até a foto mais reproduzida do Japão: pagode vermelho e o Fuji nevado atrás.",
    transport: "Ônibus direto de Shinjuku (~2h, ¥2.200)", tip: "Dezembro tem a melhor visibilidade do Fuji do ano. Veja a webcam em fujigoko.tv na véspera — sem céu limpo, não vá." },
  { id: "yokohama-chinatown", name: "Chinatown de Yokohama", cat: "comida", lat: 35.4437, lng: 139.6425, costBRL: 0, spendBRL: 90, duration: "2h",
    desc: "A maior Chinatown do Japão: 600+ restaurantes em poucos quarteirões.",
    transport: "JR de Tóquio ~30 min (¥480) → Minatomirai Line", tip: "Fuja do fim de semana. Nikuman de rua na porta das lojas é o programa." },
  { id: "cupnoodles-yokohama", name: "Museu do Cup Noodles (Yokohama)", cat: "geek", lat: 35.4552, lng: 139.6378, costBRL: yen(1000), spendBRL: 0, duration: "2h",
    desc: "Você monta o seu próprio pote: escolhe a sopa, 4 ingredientes e desenha a embalagem.",
    transport: "Minatomirai Line → Bashamichi", tip: "¥500 entrada + ¥500 a oficina do pote. A oficina fecha vaga quando enche.",
    howToBuy: "cupnoodles-museum.jp — entrada na hora, mas a oficina do pote pode fechar vaga" },
  { id: "minato-mirai", name: "Minato Mirai + Cosmo Clock 21", cat: "vista", lat: 35.4564, lng: 139.6380, costBRL: yen(900), spendBRL: 0, duration: "2h",
    desc: "Orla de arranha-céus com roda-gigante acesa refletindo na água. Iluminação reforçada em dezembro.",
    transport: "Minatomirai Line", tip: "Escurece 16h30 em dezembro — dá para pegar as luzes acesas ainda no meio da tarde." },
  { id: "daibutsu-kamakura", name: "Grande Buda de Kamakura (Kotoku-in)", cat: "templo", lat: 35.3167, lng: 139.5361, costBRL: yen(350), spendBRL: 0, duration: "1h",
    desc: "13 metros de bronze a céu aberto desde que um tsunami levou o pavilhão no século XV.",
    transport: "JR Yokosuka de Tóquio ~1h (¥940)", tip: "Por mais ¥50 você entra DENTRO da estátua. Quase ninguém sabe." },
  { id: "hasedera", name: "Hase-dera (Kamakura)", cat: "templo", lat: 35.3126, lng: 139.5329, costBRL: yen(400), spendBRL: 0, duration: "1h30",
    desc: "Jardim em terraços com a melhor vista de mar do circuito de Kamakura.",
    transport: "Enoden → estação Hase", tip: "Ar limpo de dezembro deixa o Fuji visível do outro lado da baía." },
  { id: "nikko-toshogu", name: "Santuário Toshogu (Nikko)", cat: "templo", lat: 36.7581, lng: 139.5986, costBRL: yen(1600), spendBRL: 0, duration: "3h",
    desc: "Mausoléu dourado de Tokugawa Ieyasu, com os três macacos originais. O oposto do minimalismo japonês.",
    transport: "Tobu de Asakusa, ~2h", tip: "Em dezembro a parte alta (Lago Chuzenji, Cataratas Kegon) pode estar com estrada fechada. Conte só com o Toshogu." },
  { id: "kasuga-taisha", name: "Kasuga Taisha (Nara)", cat: "templo", lat: 34.6813, lng: 135.8484, costBRL: yen(1000), spendBRL: 0, duration: "2h",
    desc: "Alameda de 2.000 lanternas de pedra na floresta + mil lanternas de bronze nos beirais.",
    transport: "Caminhada pelo Parque de Nara", tip: "Pague os dois ¥500: a sala escura Fujinami-no-Ya é o que as fotos mostram. Fecha ~16h30 no inverno.",
    howToBuy: "Pagamento no portão, sem reserva" },
  { id: "kofukuji", name: "Kofuku-ji + Museu do Tesouro (Nara)", cat: "templo", lat: 34.6833, lng: 135.8322, costBRL: yen(700), spendBRL: 0, duration: "2h",
    desc: "O Asura de três faces, do século VIII — uma das esculturas mais famosas do Japão.",
    transport: "Entre a estação e o parque dos cervos", tip: "O pagode de 5 andares está coberto por andaime de restauração até MARÇO DE 2034. A foto clássica não existe hoje." },
  { id: "kenrokuen", name: "Kenroku-en (Kanazawa)", cat: "daytrip", lat: 36.5620, lng: 136.6626, costBRL: yen(320), spendBRL: 0, duration: "2h",
    desc: "Um dos três grandes jardins do Japão. Em dezembro está com os yukitsuri — cordas em cone protegendo os pinheiros da neve.",
    transport: "Thunderbird de Kyoto + shinkansen, ~2h15", tip: "Os yukitsuri só existem de novembro a março. É a imagem de inverno mais famosa do jardim." },
  { id: "higashi-chaya", name: "Higashi Chaya (Kanazawa)", cat: "bairro", lat: 36.5720, lng: 136.6670, costBRL: 0, spendBRL: 40, duration: "2h",
    desc: "O distrito de casas de chá de gueixa mais preservado do Japão — mais autêntico e bem menos turístico que Gion.",
    transport: "Ônibus do centro de Kanazawa", tip: "Emende com o mercado Omicho: caranguejo do Mar do Japão em plena temporada no inverno." },
  { id: "shirakawago", name: "Shirakawa-go", cat: "daytrip", lat: 36.2578, lng: 136.9063, costBRL: 0, spendBRL: 120, duration: "Pernoite",
    desc: "Aldeia UNESCO de telhados de palha sob a neve. A imagem de todo folheto de Japão no inverno.",
    transport: "4h–5h só de ida, via Nagoya ou Kanazawa", tip: "NÃO É BATE-VOLTA de Kyoto/Osaka. E o light-up na neve é só janeiro e fevereiro, por sorteio — em dezembro não acontece." },
];
...
/*
 * Deduz a região de um POI pelas coordenadas — usado pra agrupar/filtrar
 * por "onde fica" sem precisar marcar cidade em cada um dos 178 lugares.
 * Fora das caixas de Kyoto/Osaka/Hakone cai em Tóquio (inclui arredores
 * como Kamakura, Yokohama, Fuji-Q — do jeito que guias de viagem agrupam).
 */
export function inferCity(lat, lng) {
  if (lat > 34.9 && lat < 35.15 && lng > 135.6 && lng < 135.9) return "kyoto";
  if (lat > 34.55 && lat < 34.9 && lng > 135.3 && lng < 135.65) return "osaka";
  if (lat > 35.15 && lat < 35.35 && lng > 138.9 && lng < 139.25) return "hakone";
  return "toquio";
}
