...
export const AGENCY_PACKAGES = [
  {
    ...
    days: [
      ...
      },
      {
        ...
        items: [{ name: "Tour de dia inteiro ao Monte Fuji", status: "mapa", poiId: "kawaguchiko", note: "Bate-volta de Tóquio. No mapa também há Hakone." }],
      },
      {
        date: "29/03", title: "Yokohama (opcional)",
        items: [{ name: "Yokohama: Museu Cup Noodles, Parque Yamashita, Chinatown", status: "mapa", poiId: "yokohama" }],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Santuário Kasuga Taisha (Nara)", status: "fora" },
          { name: "Templo Kofuku-ji (Nara)", status: "fora" },
        ],
      },
      {
    ...
    days: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Santuário Heian", status: "fora" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Templo Tenryu-ji", status: "fora", note: "Fica colado no bambuzal." },
      ...
      },
      {
        ...
        items: [
          { name: "Vilas de Magome e Tsumago (Rota dos Samurais)", status: "fora" },
          { name: "Takayama — rua Kamisannomachi", status: "fora" },
        ],
      },
      {
        date: "18/11", title: "Shirakawa-go → Hakone",
        items: [
          { name: "Vila de Shirakawa-go (UNESCO)", status: "fora" },
      ...
      },
      {
        ...
        items: [
          { name: "Lago Ashi e teleférico com vista do Fuji", status: "mapa", poiId: "hakone" },
          { name: "Tokyo Tower", status: "roteiro", where: "Sáb 12/12, noite" },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [{ name: "Santuário Toshogu e trilha Kanmangafuchi", status: "mapa", poiId: "nikko" }],
      },
      {
